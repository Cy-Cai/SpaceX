...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard Cy4',
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df['One'] = 1
        fig = px.pie(filtered_df, values='One', 
        names='class',
        title='Total Success Launches By Site for'+ entered_site)
        return fig
